...
- [ ] 4.1 Add a state-compat verification test that applies with the SDK v2 implementation and plans against the framework implementation, and verify the plan output is empty (no diff)
